  ...
  private void checkHasLocator( ) {
    if ( name.equals( "isOrdered" ) ) {
      ...
      HAS_MULTIPLE_LOCATORS = true;
        ...
        name.equals( "check") || name.equals( "click") || name.equals( "clickAt") || 
        name.equals( "contextMenu") || name.equals( "contextMenuAt") || name.equals( "doubleClick") ||
        name.equals( "doubleClickAt") || name.equals( "dragAndDrop") ||
        name.equals( "dragAndDropToObject") || name.equals( "dragdrop") ||
        ...
        name.equals( "getElementWidth") || name.equals( "getExpression") ||
        name.equals( "getSelectedId") || name.equals( "getSelectedIds") ||
        name.equals( "getSelectedIndex") || name.equals( "getSelectedIndexes") ||
        name.equals( "getSelectedLabel") || name.equals( "getSelectedLabels") ||
        name.equals( "getSelectedValue") || name.equals( "getSelectedValues") ||
        name.equals( "getSelectOptions") || name.equals( "getTable") || name.equals( "getText") ||
        name.equals( "getValue") || name.equals( "getXpathCount") || name.equals( "highlight") ||
        name.equals( "isChecked") || name.equals( "isEditable") || name.equals( "isElementPresent") ||
        name.equals( "isSomethingSelected") || name.equals( "isVisible") ||
        name.equals( "keyDown") || name.equals( "keyPress") || name.equals( "keyUp") ||
        name.equals( "mouseDown") || name.equals( "mouseDownAt") || name.equals( "mouseDownRight") ||
        name.equals( "mouseDownRightAt") || name.equals( "mouseMove") || name.equals( "mouseMoveAt") ||
        name.equals( "mouseOut") || name.equals( "mouseOver") || name.equals( "mouseUp") ||
        name.equals( "mouseUpAt") || name.equals( "mouseUpRight") || name.equals( "mouseUpRightAt") ||
        name.equals( "removeAllSelections") || name.equals( "removeSelection") ||
        name.equals( "select") || name.equals( "selectFrame") || name.equals( "setCursorPosition") ||
        name.equals( "submit") || name.equals( "type") || name.equals( "typeKeys") || name.equals( "uncheck" ) ) {
      HAS_LOCATOR = true;
    }
  }

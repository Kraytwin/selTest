...
//XXX This isn't really needed anymore but may be incorporated in again.        
  ...
  public void startElement(String uri, String localName, String rawName, Attributes attributes) {
         if ( rawName.equals( "Sequence" ) ) {
           ...
           //Need to get the name attribute, this will be the suffix for any files generated from this step later
  ...
  public void endDocument( ) {
   ...
   public void characters(char[] ch, int start, int length) throws SAXException { 
     if ( isPart ) {
      ...
      //Part has been set to a blank string before it has reached here; it needs to be concatenated since 
